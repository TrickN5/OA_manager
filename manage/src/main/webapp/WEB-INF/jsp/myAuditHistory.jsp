    ...
    <table class="tablelist">
        ...
        <c:forEach items="${auditings}" var="audit">
            <tr>
                ...
                <td>${audit.expense.sexptime}</td>
                <td>${audit.stime}</td>
                <td>${audit.expense.expdesc}</td>
                <td><a href="showExpenseDetail/${audit.expid}" class="tablelink"> 查看具体报销项</a></td>
                <td><a href="showExpenseImg/${audit.expid}" class="tablelink">查看所附图片</a></td>
                <td>${audit.expense.lastresult}</td>
                <td><a href="showAuditHistory/${audit.expid}" class="tablelink">查看审核记录</a></td>
            </tr>
        </c:forEach>
